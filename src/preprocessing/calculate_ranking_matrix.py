...
def compute_candidate_document_similarity(candidate_strings, candidate_embeddings, document_embeddings):
...
def main():
    ...
    candidate_embeddings = compute_candidate_embeddings(sent2vec_model, candidate_strings)
    similarity_dataframe, ranking_dataframe = compute_candidate_document_similarity(candidate_strings, candidate_embeddings, document_embeddings)
